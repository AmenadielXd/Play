    ...
    if streamtype == "playlist":
            ...
            if await is_active_chat(chat_id):
                ...
                run = await app.send_photo(
                    ...
                    caption=_["stream_1"].format(
                        f"<a href='https://t.me/{BOT_USERNAME}'>{BOT_NAME}</a>, https://t.me/{app.username}?start=info_{vidid}",
                        title[:23],
                        duration_min,
                        user_name,
                    ),
        ...
        if await is_active_chat(chat_id):
            ...
            run = await app.send_photo(
                ...
                caption=_["stream_1"].format(f"<a href='https://t.me/{BOT_USERNAME}'>{BOT_NAME}</a>", config.SUPPORT_CHAT, title[:23], duration_min, user_name
                ),
                reply_markup=InlineKeyboardMarkup(button),
            )
            db[chat_id][0]["mystic"] = run
        ...
        if await is_active_chat(chat_id):
            ...
            run = await app.send_photo(
                ...
                caption=_["stream_1"].format(f"<a href='https://t.me/{BOT_USERNAME}'>{BOT_NAME}</a>", link, title[:23], duration_min, user_name),
                reply_markup=InlineKeyboardMarkup(button),
            )
            db[chat_id][0]["mystic"] = run
            db[chat_id][0]["markup"] = "tg"
        ...
        if await is_active_chat(chat_id):
            ...
            run = await app.send_photo(
                ...
                caption=_["stream_2"].format(f"<a href='https://t.me/{BOT_USERNAME}'>{BOT_NAME}</a>", user_name),
                reply_markup=InlineKeyboardMarkup(button),
            )
            db[chat_id][0]["mystic"] = run
            db[chat_id][0]["markup"] = "tg"
